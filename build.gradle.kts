...
dependencies {
  ...
  bom(platform("org.incendo:cloud-bom:2.0.0-beta.3"))
  bom(platform("org.incendo:cloud-minecraft-bom:2.0.0-beta.4"))
  modImplementation("org.incendo:cloud-fabric:2.0.0-beta.3")
  include("org.incendo:cloud-fabric:2.0.0-beta.3")
